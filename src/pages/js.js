export const js = (lang) => {
    ...
    window.setTestTechniqueJS = async  ()=>{
        let testTechnique = {
            lang: lang,
    ...
    <div class="w-full flex flex-col items-center gap-4 h-screen pt-44 overflow-y-scroll py-11 dark:bg-gray-900">
        <div class="bg-white min-w-max dark:bg-gray-700 shadow-lg rounded-lg ">
            ...
            <h1 class="dark:text-white text-left font-black text-xl">
                Welcome to the technical<br/> test using Javascript
            </h1>
            <div class="w-full text-left">
                <br />
                <h2 class="dark:text-white">
                Create a function that sort the array [1,12,54,3,9] descending using Javascript
                </h2>
                <br />
                ...
                <button onclick='setTestTechniqueJS()' class=" bg-blue-500 text-white p-2 mt-3 rounded-md hover:bg-blue-600" id="submit">
                    Submit your answers
                </button>
                </div>
            </div>
