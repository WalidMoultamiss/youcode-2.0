...
export const Admin = ({ users, questions, switcher }) => {
    ...
    return (` 
        <div class="h-[100%]">
            <div class="h-1/4 pt-10 w-full flex justify-center dark:bg-gray-700 dark:text-white dark:border-gray-300">
            ...
            <div class="h-3/4 flex justify-center" id="dashboard">
