        ...
        <div class="header">
            <nav id="nav" class="flex items-center justify-between flex-wrap dark:bg-red-900 bg-red-500 p-6">
                <div class="flex items-center flex-shrink-0 text-white mr-6">
                    ...
                    <span class="font-semibold text-xl tracking-tight">FCC</span>
                </div>
                ...
                <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div class="text-sm lg:flex-grow">
                        <span onclick="goTo('home')" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                            Home
                        </span>
                        <span onclick="goTo('about')" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                            About
                        </span>
                    </div>
